...
from .views import (NewHomepageView, HomepageView,GeographyDetailView, TimeSeriesGeographyDetailView, CustomGeographyDetailView, TimeSeriesCustomGeographyDetailView, DistrictGeographyDetailView, GeographySearchView,
